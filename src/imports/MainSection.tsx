import svgPaths from "./svg-zguk7fq2yz";
...
function ButtonContent1() {
  return (
    <div className="basis-0 bg-[#3d5fd9] grow h-[40px] min-h-px min-w-px relative rounded-[8px] shrink-0 cursor-pointer hover:bg-[#3451b8] active:bg-[#2a4396] transition-colors" data-name="buttonContent">
...
export default function MainSection() {
  return (
    <div className="relative rounded-br-[8px] rounded-tr-[8px] w-full h-full" data-name="main section">
      <div className="w-full h-full overflow-y-auto overflow-x-hidden custom-scrollbar">
        <div className="box-border content-stretch flex flex-col gap-[24px] items-start px-[32px] py-[24px] relative w-full">
          <TableShell />
        </div>
      </div>
    </div>
